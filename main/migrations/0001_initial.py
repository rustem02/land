# Generated by Django 2.2.1 on 2022-07-02 06:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_site', models.CharField(max_length=255, verbose_name='Сайт компании')),
                ...
                ('company_percent', models.FloatField(default=0, verbose_name='Какой процент от Вашего оборота (из 100%)')),
                ('company_amount', models.FloatField(default=0, verbose_name='Какой оборот у Вашей компании за прошлый год?')),
                ('company_targeting', models.TextField(verbose_name='Средства Вы используете для расширения рынка сбыта и привлечения новых заказчиков')),
                ...
                ('company_deploy', models.TextField(verbose_name='Есть ли собственные разработки (краткое описание)')),
                ...
                ('company_regions', models.TextField(verbose_name='Регионы, где есть филиал')),
                ('company_destination_activity', models.TextField(verbose_name='В каких отраслях промышленности Вы наиболее активны? ')),
                ('company_different_services', models.TextField(verbose_name='Дополнительные сервисы компании')),
